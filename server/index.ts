...
app.get('/api/sessions/:sessionId/reports/:personaId/voice-script', statusLimiter, async (req, res) => {
  try {
...
app.post('/api/sessions/:sessionId/reports/:personaId/voice-script', statusLimiter, async (req, res) => {
  try {
    const sessionId = parseInt(req.params.sessionId, 10);
    const personaId = req.params.personaId;
...
app.post('/api/sessions/:sessionId/reports/:personaId/voice-audio', statusLimiter, async (req, res) => {
  try {
    const sessionId = parseInt(req.params.sessionId, 10);
    const personaId = req.params.personaId;
